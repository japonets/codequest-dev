...
const SolarSystem: React.FC = () => {
    ...
    useAnimation(() => {
        ...
        //estrelas
        drawStars(ctx, starsRef.current, shinyStarsRef.current, tema); 

        //sol
        drawSun(ctx, centerX, centerY, radius, sunImageRef.current!); 

        //orbitas
        drawOrbits(ctx, planets, centerX, centerY, tema);
        ...
        drawPlanets(ctx, planetPositionRef.current, planetAngles.current, centerX, centerY, tema); //desenha os planetas na nova posição calculada
